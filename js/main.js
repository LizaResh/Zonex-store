...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  $marketingCard: document.querySelector('.marketing-card'),
...
if (document.querySelector('.catalog')) {
  ...
  _vars__WEBPACK_IMPORTED_MODULE_0__["default"].$catalogChoice.addEventListener('click', e => {
    if (e.target.classList.contains('catalog-choice__item')) {
      ...
      let numb = parseInt(document.querySelector(`[data-text="${text}"]`).closest('.catalog-filter').querySelector('.catalog-filter__quantity').textContent);
      numb--;
      document.querySelector(`[data-text="${text}"]`).closest('.catalog-filter').querySelector('.catalog-filter__quantity').textContent = numb;
    }
...
/***/ "./src/js/components/marketing-card.js":
/*!*********************************************!*\
  !*** ./src/js/components/marketing-card.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
if (_vars__WEBPACK_IMPORTED_MODULE_0__["default"].$marketingCard) {
  let cardCounter = 0;
  let cardDelay = 4000;
  const dataCard = [{
    ...
    title: 'Faux shearling',
    where: 'Moscow, Russia'
  }];
  const closeMarketingCard = () => {
    _vars__WEBPACK_IMPORTED_MODULE_0__["default"].$marketingCard.classList.remove('marketing-card--visible');
  };
  const changeMarketingCardData = () => {
    _vars__WEBPACK_IMPORTED_MODULE_0__["default"].$marketingCard.classList.remove('marketing-card--visible');
    setTimeout(() => {
      _vars__WEBPACK_IMPORTED_MODULE_0__["default"].$marketingCard.classList.add('marketing-card--visible');
    }, cardDelay - 2000);
    const stringTitle = `${dataCard[cardCounter].title}`;
    const stringWhere = `15 minutes ago ${dataCard[cardCounter].where}`;
    setTimeout(() => {
      _vars__WEBPACK_IMPORTED_MODULE_0__["default"].$marketingCard.querySelector('.marketing-card__title').textContent = stringTitle;
      _vars__WEBPACK_IMPORTED_MODULE_0__["default"].$marketingCard.querySelector('.marketing-card__when-from').textContent = stringWhere;
    }, 900);
    cardCounter++;
    if (cardCounter == dataCard.length) {
      cardCounter = 0;
    }
  };
  changeMarketingCardData();
  setInterval(changeMarketingCardData, cardDelay);
  _vars__WEBPACK_IMPORTED_MODULE_0__["default"].$marketingCard.addEventListener('click', e => {
    if (e.target.classList.contains('marketing-card__close')) {
      closeMarketingCard();
    }
  });
}
...
/***/ "./src/js/components/mobile-filters.js":
/*!*********************************************!*\
  !*** ./src/js/components/mobile-filters.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/js/components/product-grid.js":
/*!*******************************************!*\
  !*** ./src/js/components/product-grid.js ***!
  \*******************************************/
/***/ (() => {
...
if (productsGrid) {
  loadMore.addEventListener('click', e => {
    productItems.forEach(e => {
      e.classList.add('products-grid__item--visible');
    });
...
/* harmony import */ var _components_marketing_card__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/marketing-card */ "./src/js/components/marketing-card.js");
...
/* harmony import */ var _components_product_grid__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/product-grid */ "./src/js/components/product-grid.js");
/* harmony import */ var _components_product_grid__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_components_product_grid__WEBPACK_IMPORTED_MODULE_11__);
...
/* harmony import */ var _components_mobile_filters__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./components/mobile-filters */ "./src/js/components/mobile-filters.js");
...
_js_vars__WEBPACK_IMPORTED_MODULE_14__["default"].$freeDeliveryBtn.addEventListener('click', () => {
  document.querySelector('.catalog-header').style.paddingTop = '0';
  document.querySelector('.hero-catalog').style.paddingTop = '92px';
